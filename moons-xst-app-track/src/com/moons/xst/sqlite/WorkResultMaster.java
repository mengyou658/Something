 ...
 */
public class WorkResultMaster extends AbstractDaoMaster {
	...
	public WorkResultMaster(SQLiteDatabase db) {
	...
	// 结果库
	public WorkResultSession newResultSession() {
		return new WorkResultSession(db, IdentityScopeType.Session,
				daoConfigMap);
	}

	public WorkResultSession newResultSession(IdentityScopeType type) {
		return new WorkResultSession(db, type, daoConfigMap);
	}
