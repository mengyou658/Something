	...
	public static class DevOpenHelper extends OpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			if(oldVersion==1000){
				...
				//1001升级1002 DJ_RESULTACTIVE表添加TransException_YN字段
				db.execSQL("ALTER TABLE DJ_RESULTACTIVE ADD 'TransException_YN' nvarchar(1)");
				//1002升级1003 DJ_RESULTACTIVE表添加AlarmDesc_TX和NoticeType_TX字段
				db.execSQL("ALTER TABLE DJ_RESULTACTIVE ADD 'AlarmDesc_TX' nvarchar(40)");
				db.execSQL("ALTER TABLE DJ_RESULTACTIVE ADD 'NoticeType_TX' nvarchar(20)");
			}
			if(oldVersion==1001){
				//1001升级1002 DJ_RESULTACTIVE表添加TransException_YN字段
				db.execSQL("ALTER TABLE DJ_RESULTACTIVE ADD 'TransException_YN' nvarchar(1)");
