...
public class ImageZoomDialog extends BaseActivity implements OnTouchListener,
	...
	private void initView() {
		...
		/*
		 * // 保存到图库 btnSave = (Button) findViewById(R.id.btn_save);
		 * btnSave.setOnClickListener(new View.OnClickListener() {
		 * 
		 * @SuppressLint("NewApi")
		 * 
		 * @Override public void onClick(View v) { try { String saveImagePath =
		 * ((AppContext) getApplication()) .getSaveImagePath();
		 * ImageUtils.saveImageToSD(ImageZoomDialog.this, saveImagePath +
		 * ImageUtils.getTempFileName() + ".jpg", bitmap, 100);
		 * UIHelper.ToastMessage(ImageZoomDialog.this, "保存成功"); } catch
	...
	private void initData() {
		...
		new Thread() {
			public void run() {
				...
				// bmp =
				// BitmapFactory.decodeResource(imgView.getResources(),R.drawable.picture1);
