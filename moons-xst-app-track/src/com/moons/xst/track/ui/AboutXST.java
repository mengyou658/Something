...
public class AboutXST extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			String aboutname = AppResourceUtils.getValue(this, getString(R.string.app_name), "aboutname");
			if (!StringUtils.isEmpty(aboutname)){
				int aboutnameID = AppResourceUtils.getStringId(this, aboutname);
				app_name.setText(getString(aboutnameID));
			}
		...
		String aboutlogo = AppResourceUtils.getValue(this, getString(R.string.app_name), "aboutlogo");
		if (!StringUtils.isEmpty(aboutlogo)){
			int aboutlogoID = AppResourceUtils.getDrawableId(this, aboutlogo);
			LogoImage.setImageResource(aboutlogoID);
		}
		...
		LogoImage.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (AppContext.getShieldOSSetTimeYN()) {
					...
					Intent intent =new Intent(AboutXST.this,OperateLogQuery.class);
		...
		String copyrightvisible = AppResourceUtils.getValue(this, getString(R.string.app_name), "copyrightvisible");
		if(StringUtils.toBool(copyrightvisible)){
