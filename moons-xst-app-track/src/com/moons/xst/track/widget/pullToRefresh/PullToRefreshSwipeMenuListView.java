package com.moons.xst.track.widget.pullToRefresh;
...
import com.moons.xst.track.widget.pullToRefresh.pulltorefresh.interfaces.OnXScrollListener;
import com.moons.xst.track.widget.pullToRefresh.pulltorefresh.view.PullToRefreshListFooter;
import com.moons.xst.track.widget.pullToRefresh.pulltorefresh.view.PullToRefreshListHeader;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.adapter.SwipeMenuAdapter;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.bean.SwipeMenu;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.interfaces.OnMenuItemClickListener;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.interfaces.OnSwipeListener;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.interfaces.SwipeMenuCreator;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.view.SwipeMenuLayout;
import com.moons.xst.track.widget.pullToRefresh.swipemenu.view.SwipeMenuView;
...
//        });
    ...
    public void setState(){
   	 if (mPullLoading == true) {
            mPullLoading = false;
            mFooterView.setState(PullToRefreshListFooter.STATE_LOADFINISH);
        }
   }
    /**
    ...
    public void setXListViewListener(Context context) {
    	mListViewListener = (IXListViewListener) context;
    }
//    public void setXListViewListener(SettingFragment l) {
//        mListViewListener = l;
//    }
//    public void setXListViewListener(HomeFragment l) {
//    	mListViewListener = l;
//    }
