package com.moons.xst.track.widget.pullToRefresh.pulltorefresh.view;
...
public class PullToRefreshListFooter extends LinearLayout {
    ...
    public final static int STATE_LOADFINISH = 3;
    ...
    public void setState(int state) {
        ...
        }else if(state == STATE_LOADFINISH){
        	mHintView.setVisibility(View.VISIBLE);
            mHintView.setText(R.string.nomoredata);
        } else {
            mHintView.setVisibility(View.VISIBLE);
