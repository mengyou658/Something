...
public class GestureContentView extends ViewGroup {
	...
	public GestureContentView(Context context, boolean isVerify, Hashtable<String, String[]> hash, GestureCallBack callBack) {
		super(context);
		screenDispaly = AppUtil.getScreenDispaly(context);
		blockWidth = screenDispaly[0] / 4;
		this.list = new ArrayList<GesturePoint>();
		...
		addChild();
		// 初始化一个可以画线的view
		gestureDrawline = new GestureDrawline(context, list, isVerify, hash, callBack);
	}
