...
public class MyChartView extends View {
	...
	private static final int DEFAULT_PADDING_SIZE = 15;
	...
	public MyChartView(Context context, AttributeSet attr) {
		...
		mDefaultColor = array.getColor(R.styleable.ChartView_defaultColor, Color.WHITE);
		mTextColor = array.getColor(R.styleable.ChartView_defaultTextColor, Color.BLACK);
		...
		mTextPaint.setAntiAlias(true); // 濞戝牓娅庨柨顖炲▏
		...
		mLinePaint.setAntiAlias(true); // 濞戝牓娅庨柨顖炲▏
		mLinePaint.setStyle(Style.FILL);
		mLinePaint.setColor(Color.GRAY);
		mLinePaint.setStrokeWidth(3);

		mCirclePaint = new Paint();
		mCirclePaint.setAntiAlias(true); // 濞戝牓娅庨柨顖炲▏
	...
	protected void onDraw(Canvas canvas) {
		...
		float mConsumeWidth = mMaxTextWidth + paddingSize * 2 + left; // 瀹歌尙绮℃担璺ㄦ暏閻ㄥ嫬顔旀惔锟?		
