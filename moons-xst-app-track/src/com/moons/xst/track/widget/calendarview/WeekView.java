...
public class WeekView extends View {
	private String[] weekArray = {
			AppContext.baseContext.getString(R.string.date_week_weekday),
			AppContext.baseContext.getString(R.string.date_week_monday),
			AppContext.baseContext.getString(R.string.date_week_tuesday),
			AppContext.baseContext.getString(R.string.date_week_wednesday),
			AppContext.baseContext.getString(R.string.date_week_thursday),
			AppContext.baseContext.getString(R.string.date_week_friday),
			AppContext.baseContext.getString(R.string.date_week_saturday) };
	...
	private void initAttrs(AttributeSet attrs) {
		...
		for (int i = 0; i < ta.getIndexCount(); i++) {
			...
			if (attr == R.styleable.WeekView_week_color) {
				weekColor = ta.getColor(R.styleable.WeekView_week_color,
						weekColor);
			} else if (attr == R.styleable.WeekView_week_size) {
				weekSize = ta.getInteger(R.styleable.WeekView_week_size,
						weekSize);
