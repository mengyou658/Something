...
public class Query_hisdataAdapter extends BaseAdapter {

	private Context context;// 运行上下文
	private List<GPSPositionForResultHis> listItems;// 数据集合
	 ...
	 * @param resource
	 */
	public Query_hisdataAdapter(Context context,
			List<GPSPositionForResultHis> data, int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 设置文字和图片
		GPSPositionForResultHis posResult = listItems.get(position);

		listItemView.title.setText(posResult.getUTCDateTime());
		listItemView.title.setTag(posResult);// 设置隐藏参数(实体类)
		listItemView.tex.setText(posResult.getAppUserName_TX());
