...
public class AppException extends Exception implements UncaughtExceptionHandler {
	...
	public final static byte TYPE_DB = 0x09;
	...
	public void makeToast(Context ctx) {
		...
		case TYPE_RUN:
			...
			break;
		case TYPE_DB:
			Toast.makeText(ctx, R.string.db_run_code_error, Toast.LENGTH_SHORT)
					.show();
			break;
		}
	}
	...
	public void saveErrorLog(Exception excp) {
		String errorlog = "errorlog_" + DateTimeHelper.getDateTimeNow2()
				+ ".txt";
		String savePath = "";
		String logFilePath = "";
		FileWriter fw = null;
	...
	public static AppException database(Exception e) {
		return new AppException(TYPE_DB, 0, e);
	}
	...
	private boolean handleException(Throwable ex) {
		...
		//final Context context =Main_Page.instance();
		if (context == null) {
			return false;
		}
