...
public class DJQueryPlan_HisAdpter extends BaseAdapter {
	private Context context;// 运行上下文
	private List<DJ_ResultHis> listItems;// 数据集合
	 ...
	 * @param resource
	 */
	public DJQueryPlan_HisAdpter(Context context, List<DJ_ResultHis> data,
			int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// 设置文字和图片
		DJ_ResultHis planhis = listItems.get(position);
