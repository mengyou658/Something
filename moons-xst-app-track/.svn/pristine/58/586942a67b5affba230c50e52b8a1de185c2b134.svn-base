...
public class DJPlanImageAdapter extends BaseAdapter {
	...
	public DJPlanImageAdapter(Context context, List<String> data,
	...
	public DJPlanImageAdapter(Context context, List<DJ_PhotoByResult> data,
			int resource) {
	...
	public DJPlanImageAdapter(Context context, List<GPSMobjectBugResultForFiles> data,int no,
			int resource) {
		List<String> _data = new ArrayList<String>();
		List<String> _titles = new ArrayList<String>();
		if (data != null) {
