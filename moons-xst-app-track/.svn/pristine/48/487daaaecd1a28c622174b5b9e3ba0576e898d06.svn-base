...
package com.moons.xst.track.widget.WheelView;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = AppContext.baseContext.getResources().getColor(R.color.xstblue);

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = AppContext.baseContext.getResources().getColor(R.color.actionsheet_gray);
	...
	/** Text size */
	private static final int TEXT_SIZE = AppContext.baseContext
			.getResources().getDimensionPixelSize(R.dimen.text_size_18);//25;

	/** Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET = TEXT_SIZE / 5;

	/** Additional width for items layout */
	private static final int ADDITIONAL_ITEMS_SPACE = AppContext.baseContext
			.getResources().getDimensionPixelSize(R.dimen.space_10);//10;

	/** Label offset */
	private static final int LABEL_OFFSET = 8;

	/** Left and right padding value */
	private static final int PADDING = AppContext.baseContext
			.getResources().getDimensionPixelSize(R.dimen.space_30);//10;
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheelview_item_bg);
		}
		...
		setBackgroundResource(R.color.alert_bgcolor);
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		centerDrawable.setBounds(0+80, center - offset, getWidth()-80, center + offset);
