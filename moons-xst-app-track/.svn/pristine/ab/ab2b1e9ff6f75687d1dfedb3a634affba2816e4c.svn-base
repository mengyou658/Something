...
*/
public class SRLineTreeLastResultDao extends AbstractDao<SRLineTreeLastResult, Void> {
    ...
    */
    ...
    public SRLineTreeLastResultDao(DaoConfig config) {
        super(config);
    }
    
    public SRLineTreeLastResultDao(DaoConfig config, DJDAOSession daoSession) {
