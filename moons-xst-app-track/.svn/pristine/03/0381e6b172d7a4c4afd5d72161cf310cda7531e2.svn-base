...
public class DJ_ResultActiveDao extends AbstractDao<DJ_ResultActive, Void> {
	...
	public static class Properties {
		...
		public final static Property TransException_YN = new Property(26,
				String.class, "TransException_YN", false, "TransException_YN");
		public final static Property AlarmDesc_TX = new Property(27,
				String.class, "AlarmDesc_TX", false, "AlarmDesc_TX");
		public final static Property NoticeType_TX = new Property(28,
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "DJ_RESULTACTIVE (" + //
				...
				"NoticeType_TX nvarchar(20));"); // 26: TransException_YN
	}
	...
	public DJ_ResultActive readEntity(Cursor cursor, int offset) {
		DJ_ResultActive entity = new DJ_ResultActive(
				...
				cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27),
	...
	public void readEntity(Cursor cursor, DJ_ResultActive entity, int offset) {
		...
		entity.setFFTData_TX(cursor.isNull(offset + 25) ? null : cursor
				.getBlob(offset + 25));
		entity.setTransException_YN(cursor.isNull(offset + 26) ? null : cursor
				.getString(offset + 26));
		entity.setAlarmDesc_TX(cursor.isNull(offset + 27) ? null : cursor
				.getString(offset + 27));
		entity.setNoticeType_TX(cursor.isNull(offset + 28) ? null : cursor
				.getString(offset + 28));
	}
